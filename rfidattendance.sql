...
(1, 'Admin', 'admin123@gmail.com', '$2y$10$89uX3LBy4mlU/DcBveQ1l.32nSianDP/E1MfUh.Z.6B4Z0ql3y7PK');
...
CREATE TABLE `users` (
  ...
  `vehiclenumber` double NOT NULL DEFAULT '0',
